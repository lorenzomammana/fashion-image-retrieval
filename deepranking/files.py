...
small_images_directory = ROOT / 'small_224'
small_images_classes_directory = ROOT / 'small_classes_224'
...
small_images_classes_kmeans_scores = small_images_classes_embeddings / 'kmeans_scores.csv'
...
reduced_embeddings_path = clusters_visualization_path / 'reduced_embeddings.csv'
test_images = ROOT / 'similarity-input'
