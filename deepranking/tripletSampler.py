        ...
        for image_name in tqdm(image_names):
            ...
            for positive_image in positive_images:
                ...
                for negative_image in negative_images:
                    f.write(query_image + ',' + positive_image + ',' + negative_image + '\n')
...
if __name__ == '__main__':
    ...
    triplet_sampler(directory_path=args.input_directory, output_path=args.output_directory,
                    num_neg_images=args.num_neg_images, num_pos_images=args.num_pos_images)
